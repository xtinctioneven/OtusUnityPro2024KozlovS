...
public class DamageRandomEnemyEffectHandler : BaseHandler<DamageRandomEnemyEffectOld>
{
    ...
    protected override void OnHandleEvent(DamageRandomEnemyEffectOld evt)
    {
