...
public class AddAbilityToTargetEffectHandler: BaseHandler<AddAbilityToTargetEffect>
{
    ...
    protected override void OnHandleEvent(AddAbilityToTargetEffect evt)
    {
        ...
        List<IEffect> targetAbilities = targetHero.GetHeroComponent<AbilityComponent>().GetAbilities();
